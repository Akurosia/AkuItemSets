...
public sealed class Localization
{
    ...
    private static readonly IReadOnlyDictionary<ClientLanguage, IReadOnlyDictionary<string, string>> Strings = new Dictionary<ClientLanguage, IReadOnlyDictionary<string, string>>
    {
        [ClientLanguage.English] = new Dictionary<string, string>
        {
            ...
            ["toolbar.onlyCurrentInstance"] = "This instance loot",
            ["toolbar.onlyCurrentInstanceHint"] = "Only show outfit sets whose source matches the current instance: {0}",
            ["toolbar.onlyCurrentInstanceNoTerritory"] = "Current territory is unknown.",
            ["table.set"] = "Set",
            ["table.obtainable"] = "Source",
        ...
        [ClientLanguage.German] = new Dictionary<string, string>
        {
            ...
            ["toolbar.onlyCurrentInstance"] = "Loot dieser Instanz",
            ["toolbar.onlyCurrentInstanceHint"] = "Zeigt nur Sets, deren Quelle zur aktuellen Instanz passt: {0}",
            ["toolbar.onlyCurrentInstanceNoTerritory"] = "Aktuelles Gebiet ist unbekannt.",
            ["table.set"] = "Set",
            ["table.obtainable"] = "Fundort",
